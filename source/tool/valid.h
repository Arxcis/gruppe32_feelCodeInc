...
namespace valid
{
  ...
  static std::regex regDouble (R"([\s]*[+-]?[0-9]{0,15}[\.]?[0-9]{1,15})"); // @robustness - could overflow floating point
  static std::regex regPhone  (R"([\s]*[+][0-9]{1,3}[ ](([0-9]{8})|(([0-9]{2}[ ]){3}[0-9]{2})|([0-9]{3}[ ][0-9]{2}[ ][0-9]{3})))");
  static std::regex regTime   (R"([\s]*[0-9]{2}[:][0-9]{2}([:][0-9]{2}([:][0-9]{3})?)?)"); // @friendlyness, demands 00:00:00:999 for milliseconds
