...
namespace valid
{
  ...
  static std::regex regPhone  ("[\\s]*[+][0-9]{1,3}[ ](([0-9]{8})|(([0-9]{2}[ ]){3}[0-9]{2})|([0-9]{3}[ ][0-9]{2}[ ][0-9]{3}))");
  static std::regex regTime   ("[\\s]*[0-9]{2}[:][0-9]{2}([:][0-9]{2}([:][0-9]{3})?)?"); // @friendlyness, demands 00:00:00:999 for milliseconds
  static std::regex regDate   ("[\\s]*(([0][1-9])|([1-2][0-9])|([3][0-1]))[\\.](([0][1-9])|([1][0-2]))[\\.](([0-9]{2})|(([1][9][0-9]{2})|([2][0]([0-9]{2}))))"); //  @robustness - Does not account for varying month-length and year-length
