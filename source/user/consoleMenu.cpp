...
namespace menu 
{
  ...
  ////////////////////////////////////////////////////////////////
  //
  //  @class menu::NationBaseMenu
  //
  NationBaseMenu::NationBaseMenu(const std::vector<int> args)
  :ConsoleMenu(args)
  {}

  void NationBaseMenu::view()
  { 
    newPage();
  ...
  int NationBaseMenu::getNextIndex(const int userInput)
  {  
    //
    // Resetting selectedContainer here, in case I dont get anything
    // 
  ...
  ////////////////////////////////////////////////////////////////
  //
  //  @class menu::ParticipantBaseMenu
  //
  ParticipantBaseMenu::ParticipantBaseMenu(const std::vector<int> args)
  :ConsoleMenu(args)
  {}

  void ParticipantBaseMenu::view()
  {
    newPage();

    selectedContainer = api_.getAll(PARTICIPANT);

    header("Participant BaseMenu");
    std::cout << "   1: New              \n";
  ...
  int ParticipantBaseMenu::getNextIndex(const int userInput)
  {  
    selectedObject = nullptr;
  ...
  ////////////////////////////////////////////////////////////////
  //
  //  @class menu::SportBaseMenu
  //
  SportBaseMenu::SportBaseMenu(const std::vector<int> args)
  :ConsoleMenu(args)
  {}

  void SportBaseMenu::view()
  {
    selectedContainer = api_.getAll(SPORT);

    newPage();
    header("Sport BaseMenu");
  ...
  int SportBaseMenu::getNextIndex(const int userInput)
  {  
    selectedObject = nullptr;
